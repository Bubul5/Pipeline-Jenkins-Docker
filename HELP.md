...
* The original package name 'springboot-jenkins-docker-app.jenkins-docker-app' is invalid and this project uses 'springbootjenkinsdockerapp.jenkinsdockerapp' instead.
